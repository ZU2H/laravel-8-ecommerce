                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <textarea name="" id="description" cols="30" rows="10" class="form-control" placeholder="Description"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="" placeholder="SKU"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" name="" id="" class="input-file" multiple
                                        wire:model="images" />
                                    @if ($images)
